...
import { ALL_TERMS, GLOSSARY } from "@/lib/glossary";
...
export const metadata: Metadata = pageMetadata({
  title: "Glossary",
  description:
    "Definitions of every term used by the Coaches and Consultants Belief Score: belief, Pattern-to-Belief Map, reinforcing loop, moment to watch, and next evidence.",
  route: "glossary",
});
...
export default function GlossaryPage() {
  return (
    <ContentPage
      route="glossary"
      title="Glossary"
      description="Definitions of the terms used by the Coaches and Consultants Belief Score and the AI Merge methodology."
      ...
      summary={
        <p>
          ...
          <strong className="font-medium text-fg">belief</strong> here is a
          possible conclusion that a repeated business experience may have
          taught someone to hold, inferred from a described pattern rather than
          diagnosed. Definitions below cover the AI Merge vocabulary, the five
          stages of the Pattern-to-Belief Map, and the coaching and consulting
    ...
    >
      ...
      <section className="rounded-2xl border border-line bg-card p-7 text-center sm:p-9">
        <h2 className="text-title">See these terms applied to your business</h2>
        <p className="mt-3">
          The free score maps one business pattern you already know well across
          all five stages of the Pattern-to-Belief Map.
        </p>
