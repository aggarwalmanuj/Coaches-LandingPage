...
const EYEBROW = "Free Coaches and Consultants Belief Score";
const HEAD_LINE_1 = "You know how to";
const HEAD_LINE_2 = "create value.";
const SUBHEAD =
  "But what belief is shaping whether that value becomes visible, sellable, and scalable? Built from your own words.";
