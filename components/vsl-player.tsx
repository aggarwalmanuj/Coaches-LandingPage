...
const CHIPS = [
  {
    text: "Built from one business pattern",
  ...
  // caveat. "Not a business assessment" and the rest live only in the FAQ.
  {
    ...
    <div className="vsl-stage relative">
      ...
      {!VSL_SRC ? (
        <div className="vsl-frame relative flex aspect-video w-full flex-col items-center justify-center gap-4 overflow-hidden rounded-2xl bg-surface px-6 text-center">
          ...
          <p className="text-title max-w-sm">
            The Coaches and Consultants walkthrough is being finalized.
          </p>
          <p className="max-w-md text-sm leading-relaxed text-faint">
            You do not need it to start. The free score works from one business
            pattern you describe in your own words.
          </p>
        </div>
      ) : (
      <div className="vsl-frame relative overflow-hidden rounded-2xl bg-surface">
        <video
          ...
          onEnded={handleEnded}
          aria-label="AI Merge Coaches and Consultants Belief Score video"
        >
