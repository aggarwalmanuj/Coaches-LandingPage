...
//
// Set to the live Coaches and Consultants Belief Score doorway domain. This is
...
export const SITE_URL = "https://coaches.aimerge.live";
...
export const ROUTES: Record<RouteKey, RouteEntry> = {
  home: { path: "/", updated: "2026-08-03", changeFrequency: "weekly", priority: 1 },
  ...
  faq: { path: "/faq", updated: "2026-08-03", changeFrequency: "monthly", priority: 0.8 },
  glossary: {
    path: "/glossary",
    updated: "2026-08-03",
  ...
  // Named correctly from the start: a coaching/consulting audience needs a
  // professional-services disclaimer, not a medical one. This site is new, so
  // there is no existing crawl equity on an older slug to preserve.
  professionalDisclaimer: {
