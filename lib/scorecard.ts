...
/** The Belief Score entry point for this funnel (the Coaches and Consultants
 ...
 *  TODO(launch): replace with the approved live Coaches and Consultants
 *  assessment URL once it exists (spec: "ASSESSMENT URL — INSERT APPROVED LIVE URL"). */
...
export const LP_SLUG = "coaches-consultants";

/**
 * The campaign this doorway belongs to, per the spec's CAMPAIGN CONTINUITY
 * block (utm_campaign=COACH_CONSULT_BELIEF_SCORE_COLD_CA). Real ad clicks
 * override it with their own utm_campaign; this is the organic/direct default.
 */
export const CAMPAIGN_ID = "COACH_CONSULT_BELIEF_SCORE_COLD_CA";
...
const DEFAULT_UTMS: Record<string, string> = {
  utm_source: "coaches-consultants",
  utm_medium: "organic",
