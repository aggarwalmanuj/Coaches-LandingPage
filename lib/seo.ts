...
export const LINKS: Record<RouteKey, RelatedLink> = {
  home: {
    ...
    label: "Coaches and Consultants Belief Score",
  ...
  glossary: {
    ...
    label: "Glossary",
    blurb: "Belief, Pattern-to-Belief Map, reinforcing loop, defined.",
  },
  privacy: {
  ...
  professionalDisclaimer: {
    ...
    blurb: "Educational scope: not consulting, legal, financial, or medical advice.",
  },
  accessibility: {
